...
public class NodoEnMalla {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while(mipuerto > puertos)
        {
            try {
                ...
                elsocket.close();
                puertos = puertos +200;//le asignamos otro puerto al nuevo Middleware
            }catch (IOException ex) {
                System.out.println("Fallo, error en la conexion para los demas");
            }
        }
                ...
                switch(arrSplit[0])
                {
                    ...
                    case "Servidor":
                        ...
                        }else
                        {
                            ...
                            outn.writeUTF(""+(mipuerto+199));// socket del servidor
    ...
    static public ServerSocket create(int portInicial) throws IOException { //Se crean los Middlewares 
        var flag = true;
        while(flag){
